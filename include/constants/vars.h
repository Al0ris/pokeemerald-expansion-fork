...
#define VAR_WILD_PKMN_ROUTE_SEEN_0                       0x40F7 // Used for Nuzlocke Route tracking
#define VAR_WILD_PKMN_ROUTE_SEEN_1                       0x40F8 // Used for Nuzlocke Route tracking
#define VAR_WILD_PKMN_ROUTE_SEEN_2                       0x40F9 // Used for Nuzlocke Route tracking
#define VAR_WILD_PKMN_ROUTE_SEEN_3                       0x40FA // Used for Nuzlocke Route tracking
#define VAR_WILD_PKMN_ROUTE_SEEN_4                       0x40FB // Used for Nuzlocke Route tracking
