...
// Custom Sprites
const u32 gObjectEventPic_Joe[] = INCBIN_U32("graphics/object_events/pics/people/JOE_SPRITE.4bpp");
const u16 gObjectEventPal_Joe[] = INCBIN_U16("graphics/object_events/palettes/JOE_SPRITE.gbapal");
